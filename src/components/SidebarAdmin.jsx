...
const SidebarAdmin = () => {
  ...
  return (
    <>
      <aside
        className={`
          fixed h-[100dvh] overflow-hidden lg:static w-11/12 max-w-[18rem] md:w-64 transition-all rounded-br-xl bg-white shadow-md shadow-gray-800/60 flex flex-col justify-between px-4 lg:transition-[width] ease-linear
          ...
          <ul className="text-gray-700 space-y-0">
            ...
            >
              <span className="min-w-max inline-flex">
                ...
                <span
                  className={`inline-flex items-center ease-linear transition-colors duration-300 ${
                    sidebarResized ? "lg:invisible" : ""
                  }`}
                >
            ...
            {isDropdownOpen && (
              <ul className="text-gray-700 space-y-1 pl-8">
                <NavLink to="/reportes">
                  <li onClick={() => handleTabSelect("reportesUsuarios")}>
                    <a
                      className={`flex items-center gap-x-4 px-3 py-2 rounded-md hover:bg-gray-400 hover:text-white ${
                        selectedTab.reportesUsuarios
                ...
                <NavLink to="/reportEst">
                  <li onClick={() => handleTabSelect("reportesEstudiantes")}>
                    <a
                      className={`flex items-center gap-x-4 px-3 py-2 rounded-md hover:bg-gray-400 hover:text-white ${
                        selectedTab.reportesEstudiantes
                          ? "text-green-500 bg-gray-200"
                          : ""
                      }`}
                    >
